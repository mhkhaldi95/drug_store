        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">أكثر الادوية صرفا</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered table-striped">
                ...
                <td>{{$index+1}}</td>
                  ...
                  <td>
                   <?php 
                   $count = Dispense::where('drug_id',$drug->id)->count();
                   $sum = Dispense::where('drug_id',$drug->id)->sum('qty');
                   ?>
                   {{ $count}}
                </td>
                <td>{{ $sum}}</td>
